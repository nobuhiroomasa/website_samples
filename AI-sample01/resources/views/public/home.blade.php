...
@section('content')
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div class="grid gap-12 lg:grid-cols-[1.2fr_0.8fr]">
            <div>
                ...
                <h2 class="mt-4 max-w-2xl text-3xl font-bold text-stone-900 sm:text-4xl" data-reveal>{{ $siteSetting->home_concept_heading }}</h2>
            </div>
        ...
        <div class="mt-12 grid gap-6 md:grid-cols-3">
            <article class="public-panel rounded-[1.75rem] p-6" data-reveal>
            ...
            <article class="public-panel rounded-[1.75rem] p-6" data-reveal data-reveal-delay="80">
            ...
            <article class="public-panel rounded-[1.75rem] p-6" data-reveal data-reveal-delay="160">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="flex items-end justify-between gap-4">
                <div>
                    ...
                    <h2 class="mt-3 text-3xl font-bold text-stone-900">{{ $siteSetting->home_stay_heading }}</h2>
                </div>
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
            <div class="grid gap-6 lg:grid-cols-2">
                <div class="public-panel rounded-[2rem] bg-stone-900 p-8 text-white" data-reveal>
            ...
            <div class="public-panel rounded-[2rem] bg-amber-100 p-8 text-stone-900" data-reveal data-reveal-delay="80">
        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="grid gap-10 lg:grid-cols-2">
                <div>
                    ...
                    <h2 class="mt-3 text-3xl font-bold text-stone-900">{{ $siteSetting->home_news_heading }}</h2>
                    <div class="mt-6 space-y-4">
                        @foreach($announcements as $announcement)
                            <article class="public-panel rounded-[1.5rem]" data-reveal>
                ...
                <div>
                    ...
                    <h2 class="mt-3 text-3xl font-bold text-stone-900">{{ $siteSetting->home_events_heading }}</h2>
                    <div class="mt-6 space-y-4">
                        @foreach($events as $event)
                            <article class="public-panel rounded-[1.5rem]" data-reveal data-reveal-delay="80">
                                @if($event->image_path)
    ...
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        <div class="flex items-end justify-between gap-4">
            <div>
                ...
                <h2 class="mt-3 text-3xl font-bold text-stone-900">{{ $siteSetting->home_gallery_heading }}</h2>
            </div>
