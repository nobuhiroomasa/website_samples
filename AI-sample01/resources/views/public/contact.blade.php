...
@section('content')
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <h1 class="mt-4 text-4xl font-bold text-stone-900" data-reveal="heading">{{ $siteSetting->contact_heading }}</h1>
        ...
        @endif
        <div class="mt-10 public-panel rounded-[2rem] p-8" data-reveal="card">
