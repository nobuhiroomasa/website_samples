...
@section('content')
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <h1 class="mt-4 text-4xl font-bold text-stone-900" data-reveal>{{ $siteSetting->about_heading }}</h1>
        ...
        <div class="mt-12 grid gap-8 lg:grid-cols-3">
            <article class="public-panel rounded-[1.75rem] p-8" data-reveal>
            ...
            <article class="public-panel rounded-[1.75rem] p-8" data-reveal data-reveal-delay="80">
            ...
            <article class="public-panel rounded-[1.75rem] p-8" data-reveal data-reveal-delay="160">
