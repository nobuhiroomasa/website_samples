...
@section('content')
    <section class="mx-auto max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
        ...
        <h1 class="mt-4 text-4xl font-bold text-stone-900" data-reveal>{{ $siteSetting->access_heading }}</h1>
        ...
        <div class="mt-12 grid gap-8 lg:grid-cols-[1.4fr_1fr]">
            <div class="public-panel rounded-[2rem]" data-reveal>
            ...
            <div class="space-y-6">
                ...
                <article class="public-panel rounded-[1.75rem] p-6" data-reveal data-reveal-delay="120">
